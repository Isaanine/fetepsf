...
<body class="bg-gray-100 overflow-x-hidden margin-auto">
    <!-- Header  -->
    <header class="bg-white shadow-lg mb-20">
        <div class="flex items-center justify-between">
            ...
            <nav id="navbar" class="hidden md:flex items-center space-x-12 gap-14">
                <a href="/prof/account" class="text-customBlue text-2xl font-itim hover:text-red-700 hover:underline hover:pb-3">Meus Dados</a>
                <a href="/prof/mural" class="text-customRed text-2xl font-itim hover:text-red-700 hover:underline hover:pb-3">Mural</a>
        ...
        <div id="mobile-menu" class="hidden bg-white py-2 px-4">
            ...
            <a href="/prof/mural" class="text-customRed text-lg font-itim hover:text-customRed">Mural</a>
    ...
    <div id="mural-container">
        ...
        <div class="flex justify-center mural-item">
    ...
    @endif
    @else
    <div class="flex justify-center items-center mt-52  mb-[307px]">
        <p class="text-2xl">Sem registros!</p>
    </div>
