    ...
    <header class="bg-white shadow-lg">
        <div class="flex items-center justify-between">
            ...
            <nav id="navbar" class="hidden md:flex items-center space-x-12 gap-14">
                <a href="#" class="customBlue text-2xl font-itim hover:text-red-700 hover:underline hover:pb-3">Meus Dados</a>
                <a href="/prof/mural" class="text-customBlue text-2xl font-itim hover:text-red-700 hover:underline hover:pb-3">Mural</a>
                <a href="/prof/chat" class="text-customRed text-2xl font-itim hover:text-red-700 hover:underline hover:pb-3">Chat</a>
            </nav>
        ...
        <div id="mobile-menu" class="hidden bg-white py-2 px-4">
            <a href="3" class="block text-customBlue text-lg font-itim py-1 hover:text-customRed">Meus Dados</a>
            <a href="/prof/mural" class="text-customBlue text-lg font-itim hover:text-customRed">Mural</a>
            <a href="/prof/chat" class="block text-customRed text-lg font-itim py-1 hover:text-customRed">Chat</a>
        </div>
    </header>
    <!-- End Header -->
        ...
        <div class="flex items-center bg-white h-12 flex-shrink-0">
            ...
            <div class="flex items-center ml-4">
                <div class="border-2 rounded-full border-black w-10 h-10 flex justify-center items-center">
                    <img src="{{ asset('images/mulher.png') }}" alt="Logo"
                        class="rounded-full w-8 h-8 object-cover">
                </div>
                <h2 class="text-xl font-bold ml-2">Marina</h2>
            </div>
        </div>
        ...
        <div class="flex-1 overflow-y-auto p-4">
            ...
            <div class="flex justify-start mb-4 mt-4">
                <div class="border-2 rounded-full border-black w-9 h-9 flex justify-center items-center">
                    <img src="{{ asset('images/homem.png') }}" alt="Logo"
                        class="rounded-full w-8 h-8 object-cover">
                </div>
                <div class="bg-white rounded-lg shadow p-3 ml-2">
                    <p class="text-gray-700 text-sm">Oi, tudo bem?</p>
                </div>
            </div>
            <div class="flex justify-end mb-4">
                <div class="bg-purple-200 rounded-lg shadow p-3 text-white mr-3">
                    <p class="text-gray-700 text-sm">Oi, tudo sim, e contigo?</p>
                </div>
                <div class=" border-2 rounded-full border-black w-9 h-9 flex justify-center items-center">
                    <img src="{{ asset('images/mulher.png') }}" alt="Logo"
                        class="rounded-full w-8 h-8 object-cover">
            ...
            <div class="flex justify-start mb-4 mt-4">
                ...
                <div class="bg-white rounded-lg shadow p-3 ml-2">
                    <p class="text-gray-700 text-sm">Tudo sim. Gostaria de avisar que na aula da semana que vem, eu me atrasarei</p>
                </div>
            </div>
            <div class="flex justify-end mb-4">
                <div class="bg-purple-200 rounded-lg shadow p-3 mr-3 text-white">
                    <p class="text-gray-700 text-sm">Obrigada por avisar, professor!</p>
                </div>
                <div class=" border-2 rounded-full border-black w-9 h-9 flex justify-center items-center">
                    <img src="{{ asset('images/mulher.png') }}" alt="Logo"
                        class="rounded-full w-8 h-8 object-cover">
